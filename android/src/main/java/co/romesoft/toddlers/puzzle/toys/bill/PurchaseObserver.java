...
import co.romesoft.toddlers.puzzle.toys.bill.BillingService.RequestPurchase;
import co.romesoft.toddlers.puzzle.toys.bill.BillingService.RestoreTransactions;
...
public abstract class PurchaseObserver {
    private static final String TAG = "INAPP PurchaseObserver";
