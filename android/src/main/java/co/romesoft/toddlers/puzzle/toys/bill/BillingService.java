...
import co.romesoft.toddlers.puzzle.toys.bill.Security.VerifiedPurchase;
...
public class BillingService extends Service implements ServiceConnection {
    private static final String TAG = "INAPP BillingService";
    ...
    class CheckBillingSupported extends BillingRequest {
        ...
        protected long run() throws RemoteException {
            ...
            try {
				Bundle response = mService.sendBillingRequest(request);  //TODO fix
