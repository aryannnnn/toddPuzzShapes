...
package co.romesoft.toddlers.puzzle.toys.bill;

import co.romesoft.toddlers.puzzle.toys.bill.Consts.PurchaseState;
import co.romesoft.toddlers.puzzle.toys.util.Base64;
import co.romesoft.toddlers.puzzle.toys.util.Base64DecoderException;
...
public class Security {
    private static final String TAG = "INAPP Security";
    ...
    public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) {
        ...
        if (!TextUtils.isEmpty(signature)) {
             ...
             */
            String base64EncodedPublicKey = "";
