    ...
    private class PurchaseAsyncTask extends AsyncTask<PurchaseResponse, Void, Boolean> {
        ...
        protected Boolean doInBackground(final PurchaseResponse... params) {
            ...
            case SUCCESSFUL:
                *//**
                ...
                case CONSUMABLE:
                    int numClicks = settings.getInt(LauncherActivity.UNLOCKED, 0);
                    editor.putInt(LauncherActivity.UNLOCKED, numClicks + 10);
                    break;
                }
                editor.commit();
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
            	...
            	//TODO some error to show, try later or buy the FULL version in the amazon store
            	//baseActivity.showProblemInAppDialog();
            }
        }
    }*/
